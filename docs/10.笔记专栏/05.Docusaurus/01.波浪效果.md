...
permalink: /Note/5e8b07
title: 波浪效果
---
## 1.创建文件夹

在 src\theme\Footer 路径下新建 Footer 文件夹

## 2.创建文件

在 Footer 文件夹分别创建 index.tsx 和 styles.module.css 文件,并填写以下配置代码
...
.header::before {
  ...
  background: url("data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 1440 320%22%3E%3Cpath fill=%22%23a2d9ff%22 fill-opacity=%221%22 d=%22M0,224L48,202.7C96,181,192,139,288,144C384,149,480,203,576,234.7C672,267,768,277,864,261.3C960,245,1056,203,1152,181.3C1248,160,1344,160,1392,160L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z%22%3E%3C/path%3E%3C/svg%3E")
    no-repeat;
